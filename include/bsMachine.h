...
namespace BS_NMSP
{
	...
	public:
		...
		void updateType(UserTypeBase* ft, bstype x, bstype y, bstype z, bstype angle, float frameTime);
#else
		void updateType(UserTypeBase* ft, bstype x, bstype y, bstype angle, float frameTime);
#endif
